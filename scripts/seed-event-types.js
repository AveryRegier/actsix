...
const EVENT_TYPE_VARIANTS = [
  {
    ...
    allowedRoles: ['deacon', 'staff', 'elder', 'usher', 'admin'],
  ...
  },
  {
    ...
    allowedRoles: ['deacon', 'elder', 'admin'],
  ...
  },
  {
    ...
    title: 'Baptism',
    positionMap: 'baptism',
    allowedRoles: ['deacon', 'staff', 'elder', 'admin'],
    assignmentRoles: ['deacon', 'staff'],
    assigneeRoles: ['deacon'],
    requiredGender: 'male',
    scheduleDependencies: [
  ...
  },
  {
    ...
    allowedRoles: ['deacon', 'staff', 'elder', 'deaconess', 'admin'],
    assignmentRoles: ['deacon', 'staff'],
